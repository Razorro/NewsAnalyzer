...
A: 推荐使用 `gpt-oss:20b-cloud` 云端模型，或本地部署的 `llama2`、`mistral` 等模型。

### Q: 如何添加自定义RSS源？

A: 在 `config/config.json` 的 `geopolitical_news.news_sources.rss_feeds` 中添加新的RSS源。
